...
document.getElementById("to_be_sketch").innerHTML = "Sketch to be drawn "+Element_of_array;
...
function updateCanvas()
{
    ...
    Element_of_array = quick_draw_data_set[random_number];
    sketch = Element_of_array;
    document.getElementById("to_be_sketch").innerHTML = "Sketch to be drawn "+sketch;
}
